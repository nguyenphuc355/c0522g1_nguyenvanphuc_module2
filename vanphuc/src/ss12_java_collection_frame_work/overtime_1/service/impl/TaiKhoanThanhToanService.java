package ss12_java_collection_frame_work.overtime_1.service.impl;

import case_study.exception.AgeInvalidException;
import ss12_java_collection_frame_work.overtime_1.exception.NotFoundBankAccountException;
import ss12_java_collection_frame_work.overtime_1.exception.NumberInvalidException;
import ss12_java_collection_frame_work.overtime_1.model.TaiKhoanNganHang;
import ss12_java_collection_frame_work.overtime_1.model.TaiKhoanThanhToan;
import ss12_java_collection_frame_work.overtime_1.service.ITaiKhoanThanhToanService;
import ss12_java_collection_frame_work.overtime_1.utils.ReadWriteFile;

import java.util.List;
import java.util.Scanner;

public class TaiKhoanThanhToanService implements ITaiKhoanThanhToanService {
    public static final String PATH = "vanphuc/src/ss12_java_collection_frame_work.case_study_2/data/taikhoanthanhtoan.csv";
